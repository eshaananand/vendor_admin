...
class DeliveryDetails extends StatelessWidget {
  var pageController;
  DeliveryDetails({super.key, this.pageController});
  ...
  Widget build(BuildContext context) {
    final List<Map<String, dynamic>> listOfColumns = [
      {
        "NAME": "Steak",
        "LICENSE": "234, Purbanchal School Road",
        "VEHICLE": "123456789",
        "PHONE": "YES",
        "AVAILABLE": "YES",
        "ACTIVE": "NO",
                                      ...
                                      ((entry) {
                                        ...
                                        return DataRow(
                                          cells: <DataCell>[
                                            ...
                                            DataCell(
                                                Text(entry.value["LICENSE"])),
                                            DataCell(
                                                Text(entry.value["VEHICLE"])),
                                            DataCell(
                                            ...
                                            DataCell(Text(entry.value["ACTIVE"],
                                                style: fontStyle(
                                                  color: isActive
                                                      ? Colors.green
                                                      : accentColor,
