...
class DeliveryPayment extends StatelessWidget {
  var pageController;
  DeliveryPayment({super.key, this.pageController});
                                        ...
                                        return DataRow(
                                          cells: <DataCell>[
                                            DataCell(Text(entry.value[
                                                "PRODUCT"])), //Extracting from Map element the value
                                            DataCell(
                                                Text(entry.value["AMOUNT"])),
                                            DataCell(
                                                Text(entry.value["RECIVER"])),
