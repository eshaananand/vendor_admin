...
class Notifications extends StatelessWidget {
  var pageController;
  Notifications({super.key, this.pageController});
                                ...
                                child: SingleChildScrollView(
                                  child: DataTable(
                                    ...
                                    columns: const [
                                      ...
                                      DataColumn(label: Text('NOTIFIED AT')),
                                      ...
                                      ((entry) {
                                        return DataRow(
                                          cells: <DataCell>[
                                            ...
                                            DataCell(Text(entry.value["READ"],
                                                style: TextStyle(
                                                  color: accentColor,
                                                ))),
                                            DataCell(Text(entry.value["AT"])),
                                            DataCell(
                                                Text(entry.value["NOTIFIED"])),
